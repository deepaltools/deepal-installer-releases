...
Программа также показывает **код инженерного меню** вашей машины на её текущую дату — он
нужен, чтобы включить отладку по ADB.
...
1. **Включите отладку по ADB** в инженерном меню машины. Код входа в это меню программа
   показывает сама — он считается на сегодняшнюю дату вашей машины.
